      ...
      <section className="bg-paper px-6 py-20 sm:px-12 lg:px-[86px]">
        <div className="mx-auto grid max-w-[1140px] gap-12 md:grid-cols-[0.85fr_1.15fr] lg:gap-16">
          <div>
            ...
            <a href={`mailto:${SITE.email}`} className="flex items-center gap-4 rounded-2xl border border-[var(--color-line)] bg-white px-6 py-5 no-underline shadow-[0_16px_36px_-26px_rgba(20,40,20,0.4)]">
